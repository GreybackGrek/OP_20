...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('22,000,000'); // Your max supply. (Here, 1 billion tokens)
        const decimals: u8 = 5; // Your decimals.
        const name: string = 'Versus'; // Your token name.
        const symbol: string = 'VS'; // Your token symbol.
