...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u128.fromString('22,000,000'); // Your max supply. (Here, 1 billion tokens)
        const decimals: u8 = 7; // Your decimals.
        const name: string = 'GreybackGrek'; // Your token name.
        const symbol: string = 'GKG'; // Your token symbol.
